...
//Now change the food key in your favoriteThings object 
//to be 'Lettuce' and change the book key in your favoriteThings object to be '50 Shades of Gray'. 
  //Your code here
...
console.log("My information is " + user.name + ", " + user.username + ", " + user.pwHash);
...
/* NEXT PROBLEM - NEXT PROBLEM - NEXT PROBLEM */
//write a function called voweler that accepts a string, and returns an object with the keys being all the vowels in 
//that string, and the values being how many times that particular vowel was in the string.
...
// Can't get it to loop through 'if' statements and add properly
